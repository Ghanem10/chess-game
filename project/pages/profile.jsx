...
export default function Profile() {
    ...
    useEffect(() => {
        const userCredentials = async () => {
            if (userToken) {
                try {
                    const user = await instanceAPI.get("/user/profile", { userToken });
                } catch (error) {
        ...
        <div className='profile-page-container'>
            <div className='profile-page-header'>
                <div className='profile-info'>
                    ...
                    <div className='profile-page-header-info'>
                        <h2>Guest</h2>
                        <span>
                            <strong>Email:</strong> Guest
                        </span>
                        <span>
                            <strong>Location:</strong> Guest
                        </span>
                    </div>
                </div>
            ...
            <div className='profile-page-body'>
                ...
                <div className='profile-page-status'>
                    <span>Wins: <strong>0</strong></span>
                    <span>Losess: <strong>0</strong></span>
                    <span>Draws: <strong>0</strong></span>
                </div>
                ...
                <span>Total points: <strong>500</strong></span>
            </div>           
        </div>
    );
}